...
atm_file = 'atm/atm_KELT9b.txt' # TP and Kzz (optional) file
# atm_file = 'atm/atm_HD189_Kzz.txt' # TP and Kzz (optional) file
sflux_file = 'atm/stellar_flux/sflux-KELT9.txt' # sflux-HD189_B2020.txt This is the flux density at the stellar surface
...
out_name =  'KELT9.vul' # output file name
...
# const_mix = {'CH4':2.7761E-4*2, 'O2':4.807e-4, 'He':0.09691, 'N2':0., 'H2':1. -2.7761E-4*2*4/2} 

# ====== Setting up photochemistry ======
use_photo = True
# astronomy input

r_star = 2.362 # stellar radius in solar radius
Rp = 1.936*7.1492E9 # Planetary radius (cm) (for computing gravity)
orbit_radius = 0.03368 # planet-star distance in A.U.
...
P_b = 1e5  # pressure at the bottom (dyne/cm^2)
...
plot_spec = ['H2O', 'H', 'CH4', 'C2H6', 'CO', 'CO2', 'C2H2']
# output:
