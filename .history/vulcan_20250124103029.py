...
if len(sys.argv) < 2 or sys.argv[1] != '-n': 
    ...
    os.system(f'{python_executable} make_chem_funs.py')
else: pass
...
if vulcan_cfg.use_condense : make_atm.sp_sat(data_atm)
...
if vulcan_cfg.use_lowT_limit_rates : data_var = rate.lim_lowT_rates(data_var, data_atm)
